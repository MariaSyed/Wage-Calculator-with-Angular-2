...
const styles_HeaderComponent:any[] = ['li[_ngcontent-%COMP%] {\n          background-color: white;\n          border-radius: 5px;\n          margin: 10px;\n        }'];
...
class _View_HeaderComponent0 extends import1.AppView<import3.HeaderComponent> {
  ...
  createInternal(rootSelector:string):import2.AppElement {
    ...
    this._text_9 = this.renderer.createText(this._el_8,'See Timesheet',(null as any));
    ...
    this._text_13 = this.renderer.createText(this._el_12,'See Salaries',(null as any));
  ...
  detectChangesInternal(throwOnChange:boolean):void {
    ...
    changes = (null as any);
    const currVal_2:any = this._arr_0('/timesheet');
    ...
    changes = (null as any);
    const currVal_6:any = this._arr_1('/salaries');
...
export function viewFactory_HeaderComponent0(viewUtils:import4.ViewUtils,parentInjector:import5.Injector,declarationEl:import2.AppElement):import1.AppView<import3.HeaderComponent> {
  if ((renderType_HeaderComponent === (null as any))) { (renderType_HeaderComponent = viewUtils.createRenderComponentType('C:/Users/Maria_2/Documents/WageCalulator/wc-from-scratch/assets/app/content-pages/header.component.ts class HeaderComponent - inline template',0,import8.ViewEncapsulation.Emulated,styles_HeaderComponent,{})); }
