...
class AppModuleInjector extends import0.NgModuleInjector<import1.AppModule> {
  ...
  _ContentPagesModule_8:import9.ContentPagesModule;
  ...
  __WindowRef_41:import27.WindowRef;
  __TimesheetService_42:import28.TimesheetService;
  __SalaryService_43:import29.SalaryService;
  __ROUTER_CONFIGURATION_44:any;
  __LocationStrategy_45:any;
  __Location_46:import30.Location;
  __UrlSerializer_47:import31.DefaultUrlSerializer;
  __RouterOutletMap_48:import32.RouterOutletMap;
  __NgModuleFactoryLoader_49:import33.SystemJsNgModuleLoader;
  __ROUTES_50:any[];
  __Router_51:any;
  ...
  get _WindowRef_41():import27.WindowRef {
    if ((this.__WindowRef_41 == (null as any))) { (this.__WindowRef_41 = new import27.WindowRef()); }
    return this.__WindowRef_41;
  }
  get _TimesheetService_42():import28.TimesheetService {
    if ((this.__TimesheetService_42 == (null as any))) { (this.__TimesheetService_42 = new import28.TimesheetService(this._Http_39,this._WindowRef_41)); }
    return this.__TimesheetService_42;
  }
  get _SalaryService_43():import29.SalaryService {
    if ((this.__SalaryService_43 == (null as any))) { (this.__SalaryService_43 = new import29.SalaryService(this._Http_39,this._WindowRef_41)); }
  ...
  get _LocationStrategy_45():any {
    if ((this.__LocationStrategy_45 == (null as any))) { (this.__LocationStrategy_45 = import6.provideLocationStrategy(this.parent.get(import44.PlatformLocation),this.parent.get(import45.APP_BASE_HREF,(null as any)),this._ROUTER_CONFIGURATION_44)); }
    return this.__LocationStrategy_45;
  }
  get _Location_46():import30.Location {
    if ((this.__Location_46 == (null as any))) { (this.__Location_46 = new import30.Location(this._LocationStrategy_45)); }
    return this.__Location_46;
  }
  get _UrlSerializer_47():import31.DefaultUrlSerializer {
    if ((this.__UrlSerializer_47 == (null as any))) { (this.__UrlSerializer_47 = new import31.DefaultUrlSerializer()); }
    return this.__UrlSerializer_47;
  }
  get _RouterOutletMap_48():import32.RouterOutletMap {
    if ((this.__RouterOutletMap_48 == (null as any))) { (this.__RouterOutletMap_48 = new import32.RouterOutletMap()); }
    return this.__RouterOutletMap_48;
  }
  get _NgModuleFactoryLoader_49():import33.SystemJsNgModuleLoader {
    if ((this.__NgModuleFactoryLoader_49 == (null as any))) { (this.__NgModuleFactoryLoader_49 = new import33.SystemJsNgModuleLoader(this._Compiler_17,this.parent.get(import33.SystemJsNgModuleLoaderConfig,(null as any)))); }
    return this.__NgModuleFactoryLoader_49;
  }
  get _ROUTES_50():any[] {
      if ((this.__ROUTES_50 == (null as any))) { (this.__ROUTES_50 = [[
        {
          path: '',
  ...
  get _Router_51():any {
    if ((this.__Router_51 == (null as any))) { (this.__Router_51 = import6.setupRouter(this._ApplicationRef_16,this._UrlSerializer_47,this._RouterOutletMap_48,this._Location_46,this,this._NgModuleFactoryLoader_49,this._Compiler_17,this._ROUTES_50,this._ROUTER_CONFIGURATION_44)); }
    return this.__Router_51;
  }
  get _ActivatedRoute_52():any {
    if ((this.__ActivatedRoute_52 == (null as any))) { (this.__ActivatedRoute_52 = import6.rootRoute(this._Router_51)); }
    return this.__ActivatedRoute_52;
  }
  get _APP_BOOTSTRAP_LISTENER_53():any[] {
    if ((this.__APP_BOOTSTRAP_LISTENER_53 == (null as any))) { (this.__APP_BOOTSTRAP_LISTENER_53 = [import6.initialRouterNavigation(this._Router_51,this._ROUTER_CONFIGURATION_44)]); }
  ...
  createInternal():import1.AppModule {
    ...
    this._ApplicationRef__15 = new import13.ApplicationRef_(this.parent.get(import42.NgZone),this.parent.get(import50.Console),this,this._ErrorHandler_12,this,this._ApplicationInitStatus_13,this.parent.get(import12.TestabilityRegistry,(null as any)),this._Testability_14);
  ...
  getInternal(token:any,notFoundResult:any):any {
    ...
    if ((token === import9.ContentPagesModule)) { return this._ContentPagesModule_8; }
    ...
    if ((token === import27.WindowRef)) { return this._WindowRef_41; }
    if ((token === import28.TimesheetService)) { return this._TimesheetService_42; }
    if ((token === import29.SalaryService)) { return this._SalaryService_43; }
    if ((token === import6.ROUTER_CONFIGURATION)) { return this._ROUTER_CONFIGURATION_44; }
    if ((token === import45.LocationStrategy)) { return this._LocationStrategy_45; }
    if ((token === import30.Location)) { return this._Location_46; }
    if ((token === import31.UrlSerializer)) { return this._UrlSerializer_47; }
    if ((token === import32.RouterOutletMap)) { return this._RouterOutletMap_48; }
    if ((token === import61.NgModuleFactoryLoader)) { return this._NgModuleFactoryLoader_49; }
    if ((token === import62.ROUTES)) { return this._ROUTES_50; }
    if ((token === import49.Router)) { return this._Router_51; }
    if ((token === import63.ActivatedRoute)) { return this._ActivatedRoute_52; }
    if ((token === import39.APP_BOOTSTRAP_LISTENER)) { return this._APP_BOOTSTRAP_LISTENER_53; }
