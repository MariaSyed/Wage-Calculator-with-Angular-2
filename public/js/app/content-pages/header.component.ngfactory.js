...
var styles_HeaderComponent = ['li[_ngcontent-%COMP%] {\n          background-color: white;\n          border-radius: 5px;\n          margin: 10px;\n        }'];
...
var _View_HeaderComponent0 = (function (_super) {
    ...
    _View_HeaderComponent0.prototype.createInternal = function (rootSelector) {
        ...
        this._text_9 = this.renderer.createText(this._el_8, 'See Timesheet', null);
        ...
        this._text_13 = this.renderer.createText(this._el_12, 'See Salaries', null);
    ...
    _View_HeaderComponent0.prototype.detectChangesInternal = function (throwOnChange) {
        ...
        changes = null;
        var currVal_2 = this._arr_0('/timesheet');
        ...
        changes = null;
        var currVal_6 = this._arr_1('/salaries');
...
export function viewFactory_HeaderComponent0(viewUtils, parentInjector, declarationEl) {
    if ((renderType_HeaderComponent === null)) {
        (renderType_HeaderComponent = viewUtils.createRenderComponentType('C:/Users/Maria_2/Documents/WageCalulator/wc-from-scratch/assets/app/content-pages/header.component.ts class HeaderComponent - inline template', 0, import8.ViewEncapsulation.Emulated, styles_HeaderComponent, {}));
    }
